---
slug: recovery-international-construction-payment-disputes-recovery-strategies
title_zh: 国际工程款追收的实务路径
title_en: International Construction Payment Disputes: Recovery Strategies
description_zh: 海外工程项目拖欠工程款，如何跨境追收？本文给出从合同与证据梳理、催收与协商、仲裁诉讼到判决执行的实务路径，并说明时间费用预期与常见风险，帮你少走弯路、及时止损。
...
- 拿到判决/裁决只是第一步，真正的价值在**跨境执行**：依据《纽约公约》（仲裁）或双边/多边司法协助安排（判决）向债务人所在地法院申请承认与执行；
...
| 环节 | 经验周期 | 主要成本 |
|------|---------|---------|
| 证据梳理与催收 | 数天至数周 | 低（固定函件/咨询费） |
| 财产保全/冻结 | 依法域 | 保全担保+律师费 |
| 仲裁/诉讼至裁决 | 数月（一般 6–24 个月不等） | 律师费+仲裁/诉讼费 |
| 跨境承认与执行 | 数月（通常 6–18 个月，视法域） | 执行地律师费+法院费用 |
...
|-------|------------------|------------|
| Evidence review and demand | Days to weeks | Low (fixed letter/consult fee) |
| Preservation / freezing | Jurisdiction-dependent | Security + counsel fees |
| Arbitration/litigation to award | Several months (commonly 6–24 months) | Counsel + arbitration/court fees |
| Cross-border recognition and enforcement | Several months (commonly 6–18 months, by jurisdiction) | Enforcement counsel + court costs |
