...
- **国家专页**:`/countries`（及 `/en/countries`）为高商业意图落地页，现覆盖 13 个国家/地区：
  美国、加拿大、澳大利亚、新加坡、英国、香港、德国、日本、阿联酋、新西兰、马来西亚、法国、
  瑞士。每页含覆盖服务、当地实务要点（执行路径/时效/税务）、处理路径与 CTA，并带
  LegalService + FAQPage 结构化数据（可出富摘要）；数据在 `COUNTRIES` 字典中维护，新增国家
  加一个条目即可。首页全球网络区块已联动链接（中英文 href 自动切换）。
